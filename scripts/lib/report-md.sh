...
generate_md_report() {
  ...
  # Extract metadata
  local project_key project_name branch report_date sonar_url analysis_id
...
> Report generated by [sonarqube-api-for-report](https://github.com/sonarqube-api-for-report) on ${report_date}
MARKDOWN
