...
@test "fetch_all_metrics: returns complete JSON structure" {
  ...
  log_info() { :; }
  log_ok()   { :; }
  export -f fetch_quality_gate fetch_measures fetch_issues_summary fetch_hotspots_summary fetch_all_issues log_info log_ok
...
@test "fetch_all_metrics: fails when fetch_quality_gate fails" {
  ...
  log_ok()   { :; }
  log_error() { :; }
  export -f fetch_quality_gate fetch_measures fetch_issues_summary fetch_hotspots_summary fetch_all_issues log_info log_ok log_error
